...
CETUSROOT=$PWD
SRC="$CETUSROOT/src/*/*/*.java $CETUSROOT/src/*/*/*/*.java $CETUSROOT/src/*/*/*/*/*.java $CETUSROOT/src/*/*/*/*/*/*.java $CETUSROOT/src/*/*/*/*/*/*/*.java $CETUSROOT/src/*/*/*/*/*/*/*/*.java"
...
java -cp $classpath -Xmx1g chen.exec.ChenDriver \$*
EOF
  chmod 755 bin/cetus
  ;;
  *)
